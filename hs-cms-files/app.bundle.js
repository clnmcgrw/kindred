...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var flickity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! flickity */ \"./node_modules/flickity/js/index.js\");\n/* harmony import */ var flickity__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(flickity__WEBPACK_IMPORTED_MODULE_0__);\n\nvar gs = document.querySelectorAll('.ks-galleryslider');\n/* harmony default export */ __webpack_exports__[\"default\"] = (function () {\n  if (!gs) return;\n  gs.forEach(function (slider) {\n    var container = slider.querySelector('.ks-flickity-container');\n    var flickity = new flickity__WEBPACK_IMPORTED_MODULE_0___default.a(container, {\n      cellSelector: '.ks-galleryslider__slide',\n      pageDots: false,\n      prevNextButtons: false\n    });\n    var state = {\n      targets: {\n        progressThumb: slider.querySelector('.ks-galleryslider__progress-thumb'),\n        progressTrack: slider.querySelector('.ks-galleryslider__progress-line'),\n        currentSlide: slider.querySelector('.ks-galleryslider__slide-number-current'),\n        totalSlides: slider.querySelector('.ks-galleryslider__slide-number-total'),\n        previous: slider.querySelector('.ks-galleryslider__button--prev'),\n        next: slider.querySelector('.ks-galleryslider__button--next'),\n        fsToggle: slider.querySelectorAll('.ks-galleryslider__fullscreen-toggle')\n      },\n      mounted: function mounted(targets) {\n        state.addListeners(targets);\n      },\n      // methods ------------------------------//\n      addListeners: function addListeners(targets) {\n        var previous = targets.previous,\n            next = targets.next,\n            fsToggle = targets.fsToggle;\n        state.assignInitialPositions(targets);\n        flickity.on('change', function () {\n          state.assignPositions();\n          state.trackProgress(targets);\n        });\n        previous.addEventListener('click', function () {\n          flickity.previous(false);\n        });\n        next.addEventListener('click', function () {\n          flickity.next(false);\n        });\n        fsToggle.forEach(function (toggle) {\n          toggle.addEventListener('click', function () {\n            state.toggleFullscreen();\n          });\n        });\n      },\n      assignInitialPositions: function assignInitialPositions(targets) {\n        var totalSlides = targets.totalSlides;\n        var wait = setInterval(function () {\n          // wait for flickity to initialize\n          if (flickity.slides) {\n            state.assignPositions(targets);\n            state.trackProgress(targets);\n            totalSlides.innerHTML = flickity.slides.length;\n            clearInterval(wait);\n          }\n        }, 100);\n      },\n      toggleFullscreen: function toggleFullscreen() {\n        switch (true) {\n          case slider.classList.contains('fullscreen'):\n            {\n              slider.classList.remove('fullscreen');\n              flickity.resize();\n              break;\n            }\n\n          case !slider.classList.contains('fullscreen'):\n            {\n              slider.classList.add('fullscreen');\n              break;\n            }\n\n          default:\n            {\n              console.warn('Unable to toggle fullscreen.');\n            }\n        }\n      },\n      trackProgress: function trackProgress(targets) {\n        var progressTrack = targets.progressTrack,\n            progressThumb = targets.progressThumb,\n            currentSlide = targets.currentSlide;\n        var widthPerSlide = progressTrack.offsetWidth / flickity.slides.length;\n        progressThumb.style.width = \"\".concat(widthPerSlide, \"px\");\n        progressThumb.style.transform = \"translate(\\n          \".concat(widthPerSlide * flickity.selectedIndex, \"px, -50%)\");\n\n        if (flickity.slides.length >= 10 && flickity.selectedIndex + 1 < 10) {\n          currentSlide.innerHTML = \"0\".concat(flickity.selectedIndex + 1);\n        } else if (flickity.slides.length >= 10 && flickity.selectedIndex + 1 >= 10) {\n          currentSlide.innerHTML = \"\".concat(flickity.selectedIndex + 1);\n        } else {\n          currentSlide.innerHTML = \"\".concat(flickity.selectedIndex + 1);\n        }\n      },\n      assignPositions: function assignPositions() {\n        flickity.slides.forEach(function (slide, index) {\n          if (index < flickity.selectedIndex) {\n            slide.cells[0].element.classList.add('is-left');\n          } else {\n            slide.cells[0].element.classList.add('is-right');\n          }\n\n          if (slide.cells[0].element.classList.contains('is-selected')) {\n            slide.cells[0].element.classList.remove('is-left');\n            slide.cells[0].element.classList.remove('is-right');\n          }\n        });\n      }\n    };\n    state.mounted(state.targets);\n  });\n});\n\n//# sourceURL=webpack:///./src/js/gallery-slider.js?");
